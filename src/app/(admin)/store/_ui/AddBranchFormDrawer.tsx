...
import Form, { RefMethods } from './BranchForm'
...
function FormDrawer(props: Props) {
  ...
  return (
    <DrawerForm type={DrawerFormType.CREATE} onClose={props.onClose} onSubmit={handleDrawerSubmit} {...rest}>
      <Form initialValues={initialValues} ref={formRef} onFinish={handleFinish} showSubmitBtn={false} />
    </DrawerForm>
  )
}
